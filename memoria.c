...
if(strcmp(argv[1], "-v") == 0){//memoria virtual----------------------------------------------------------------------------------------------------------------------------------------
    ...
    if(argc < 3){
        ...
        char *seraNUMERICO = argv[2];
        while (*seraNUMERICO) {
        // si uno solo es ABC sale
            if (!isdigit(*seraNUMERICO)){
                printf("PID no valido no es numerico\n");
                return 0;
            }
            seraNUMERICO++; // sig char
        }
    ...
    if(argc < 3){
        ...
        return 0;
                        ...
                        if (mfpid != -1) {
                            ...
                            printf("Nunaca deberia llegar aca\n");
                            return 0;
                        }
                        else{
                            printf("PID no valido \n");
